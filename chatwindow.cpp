...
ChatWindow::ChatWindow(QWidget *parent)
    ...
    , m_chatClient(new ChatStaff(this))
    , m_chatModel(new QStandardItemModel(this))
{
    ...
    connect(m_chatClient, &ChatStaff::connected, this, &ChatWindow::connectedToServer);
    connect(m_chatClient, &ChatStaff::loggedIn, this, &ChatWindow::loggedIn);
    connect(m_chatClient, &ChatStaff::loginError, this, &ChatWindow::loginFailed);
    connect(m_chatClient, &ChatStaff::messageReceived, this, &ChatWindow::messageReceived);
    connect(m_chatClient, &ChatStaff::disconnected, this, &ChatWindow::disconnectedFromServer);
    connect(m_chatClient, &ChatStaff::error, this, &ChatWindow::error);
    connect(m_chatClient, &ChatStaff::userJoined, this, &ChatWindow::userJoined);
    connect(m_chatClient, &ChatStaff::userLeft, this, &ChatWindow::userLeft);
